...
public class SearchSandbox02 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void searchSandbox02() {
        ...
        ViewInteraction editText = onView(
            allOf(withId(R.id.detail_title),
                childAtPosition(
                    ...
                    1),
                isDisplayed()));
        editText.perform(replaceText("foo"), closeSoftKeyboard());
            ...
            allOf(withId(R.id.detail_content),
                childAtPosition(
                    childAtPosition(
                        ...
                        1),
                    0)));
        editText2.perform(scrollTo(), replaceText("bar\n"), closeSoftKeyboard());
        ...
        ViewInteraction searchAutoComplete2 = onView(
            allOf(withId(R.id.search_src_text),
                childAtPosition(
                    ...
                    0),
                isDisplayed()));
        searchAutoComplete2.perform(replaceText("foo"), closeSoftKeyboard());

        ViewInteraction searchAutoComplete3 = onView(
            allOf(withId(R.id.search_src_text), withText("foo"),
                childAtPosition(
                    allOf(withId(R.id.search_plate),
                        childAtPosition(
                            withId(R.id.search_edit_frame),
